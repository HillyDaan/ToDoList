...
{
    [Fact]
    public void CalculateTopTasks_CalculatesTopTasksCorrectly()
    {
        // Arrange
        ...
        Assert.Equal("task 3", topTasks[0].Title); // Task 3 should be first (highest priority)
        Assert.Equal("task 1", topTasks[1].Title); // Task 1 should be second
        Assert.Equal("task 2", topTasks[2].Title); // Task 2 should be third
    }
